...
export default function ConfirmDialog({
  ...
  const variantConfig = {
    ...
    info: {
      ...
      button: 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-lg shadow-blue-500/25',
    },
  };
      ...
      >
        <div className="p-6">
          ...
          <div className="mt-6 flex gap-3">
            ...
            <button
              onClick={onConfirm}
              className={`flex-1 px-4 py-2.5 text-white font-medium rounded-xl transition-all ${config.button}`}
            >
              {confirmText}
            </button>
          </div>
